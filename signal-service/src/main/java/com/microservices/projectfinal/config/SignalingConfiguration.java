...
import com.microservices.projectfinal.security.JwtTokenValidator;
        ...
        registration.interceptors(new ChannelInterceptor() {
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (StompCommand.CONNECT.equals(accessor.getCommand())) {
                    ...
                    var validated = jwtTokenValidator.validateAuthorizationHeader(token);
                    SecurityContextHolder.getContext().setAuthentication(validated);

                    accessor.setUser(validated);
                }
